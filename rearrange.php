...
$elements = $DB->get_records('customcert_elements', array('pageid' => $pid));
...
$PAGE->requires->js_init_call('M.mod_customcert.rearrange.init', array($elements), false, $module);
...
$html .= html_writer::start_tag('div', array('id' => 'pdf', 'style' => 'width: ' . $page->width .
    'mm; height: ' . $page->height . 'mm'));
if ($elements) {
    foreach ($elements as $element) {
        // Get an instance of the element class.
        if ($e = customcert_get_element_instance($element)) {
            $html .= html_writer::tag('div', $e->render_html(), array('class' => 'element', 'id' => 'element-' . $element->id));
        }
    }
}
$html .= html_writer::end_tag('div');
